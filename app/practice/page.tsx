...
const ALL_TOOLS = [
  { phase: '01', name: 'Ancient Wisdom', desc: 'Rotating wisdom from 16 traditions. Daily inspiration rooted in timeless truth.' },
  ...
  { phase: '02', name: 'Fear Alchemist', desc: '6-stage somatic process that transforms fear into its hidden evolutionary gift.' },
  ...
  { phase: '03', name: 'Visualisation Meditation', desc: '20-min guided meditation into your future self. The most powerful tool in the practice.' },
  { phase: '04', name: 'Gratitude Portal', desc: 'Gratitude chips + miracle morning sequence + heart-pulse activation.' },
  ...
  { phase: '04', name: 'Feminine Way', desc: '7 feminine qualities + wisdom carousel + daily affirmations. Reclaim the full spectrum of your nature.' },
  { phase: '04', name: 'Masculine Way', desc: '7 masculine qualities + wisdom carousel + affirmations. Balance the full energetic spectrum.' },
