...
const PORTALS = [
  {
    ...
    step: '01',
    name: 'Ancient Wisdom',
    tagline: 'A new wisdom card every day.',
    description:
      'Daily transmission from 16 wisdom traditions. What was always yours to know — returned to you, one day at a time.',
    color: 'rgba(179,136,255,0.14)',
    src: '/images/app-mobile-wisdom.png',
  ...
  },
  {
    ...
    tagline: 'Your inner state is the signal.',
    description:
      'Map where you are. Tune to where you are going. Tap where you honestly are and receive a specific practice to work with what is present.',
    color: 'rgba(136,180,255,0.12)',
    src: '/images/app-mobile-tuner.png',
  ...
  },
  {
    ...
    tagline: 'Come not to list but to feel.',
    description:
      'The real kind of gratitude does not feel like appreciation — it feels like the chest opening. The most powerful daily practice in the entire app.',
